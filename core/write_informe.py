#!/usr/bin/env python3
"""Writes docs/informe_proyecto.md — EAFIT 6-section academic format."""
import pathlib

INFORME = """# Informe de Proyecto: J.A.R.V.I.S. — Ecosistema de IA Multi-LLM
...
path = pathlib.Path(r"C:\Users\Acer Nitro\jarvis_files\docs\informe_proyecto.md")
path.parent.mkdir(parents=True, exist_ok=True)
path.write_text(INFORME, encoding="utf-8")
print(f"OK: informe_proyecto.md written ({len(INFORME)} chars)")
