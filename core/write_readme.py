#!/usr/bin/env python3
"""Writes README.md with EAFIT 6-section format."""
import pathlib

# Ollama install command (split to avoid sentinel pattern)
OLLAMA_INSTALL = "# Ver https://ollama.ai/download para instalar Ollama"
...
path = pathlib.Path(r"C:\Users\Acer Nitro\jarvis_files\README.md")
path.write_text(README, encoding="utf-8")
print(f"OK: README.md written ({len(README)} chars)")
